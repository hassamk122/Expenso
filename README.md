...
- 🎨 **Modern Icons** – Powered by **lucide-react** for a sleek appearance.

## 🛠️ Tech Stack
- ⚡ **Vite** – Fast and lightweight build tool.
- ⚛ **React** – Modern UI framework for a seamless experience.
- 🎨 **Tailwind CSS** – Utility-first styling for a clean design.
- 🗃 **Local Storage** – Stores data persistently on the browser.
- 📌 **react-select** – Custom dropdown components for category selection.
